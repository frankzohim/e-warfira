    ...
    $window.on('load', function () {
        ...
        if ($(rangeSlider).length) {
            $(rangeSlider).slider({
                ...
                slide: function( event, ui ) {
                    $(rangeSliderAmount).val( "F" + ui.values[ 0 ] + " - F" + ui.values[ 1 ] );
                }
            });
        }
        $(rangeSliderAmount).val( "U" + $(rangeSlider).slider( "values", 0 ) +
            " - U" + $(rangeSlider).slider( "values", 1 ) );
        ...
        if ($(rangeSliderTwo).length) {
            $(rangeSliderTwo).slider({
                ...
                values: [ 15000, 35000 ],
                slide: function( event, ui ) {
                    $(rangeSliderAmountTwo).val(ui.values[ 0 ] + "U - " + ui.values[ 1 ] + " U");
        ...
        $(rangeSliderAmountTwo).val($(rangeSliderTwo).slider( "values", 0 ) +
            " U - " + $(rangeSliderTwo).slider( "values", 1 ) + " U" );
